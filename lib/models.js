...
Stream = (function (_super) {
  ...
  Stream.prototype.url = function () {
    if (this.source === 'youtube') {
      ...
      return 'https://www.ustream.tv/embed/' + this.reference.id + '?v=3&wmode=direct&autoplay=true';
    } else if (this.source === 'bambuser') {
      return '//embed.bambuser.com/broadcast/' + this.reference.id;
    }
  };
